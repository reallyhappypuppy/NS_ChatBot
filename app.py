    ...
    if request.method == "POST":
        ...
        if keyword:
            response_map = {
                ...
                "운세": "👍 미래는 스스로 개척하는것! 오늘의 운세 따위는 중유하지 않습니다!",
                "명언": [
                    "🌟 '실수해도 인정하고 다음에 만회하면 되는것, 그것이 인간의 특권이다.'",
                    "💡 '미래를 위해서 우리는 앞으로 나아가야만 해'",
                    "🔥 '어떤 것의 이름은 그 존재를 나타내는 지표이다. 그 지표 너머에 무엇이 있는지는 그 존재가 정하는 것이다.'",
                    "💫 '선택하지 않은 길은 존재하지 않았던 길과 같다.'",
                    "🔑 '싸우지 않으면 지킬 수 없는 것들이 있다.'",
                    "🌳 '세상이 어떻게 되든 간에, 우리는 살아가는 수밖에 없어'",
                    "🧩 '사람은 죽으면 끝이야. 하지만 살아있는 한 뭔가를 할 수 있어'",
                    ...
                    "🔭 '천재는 만능이 아닙니다. 경쟁이 낳은 슬픈 별종일 뿐일지도 모르죠.'",
                    "⛔️ '멈추지 마라. 멈추지 않으면 언젠가 다시 이루리.'",
                ],
                "메뉴": [
                    "🍜 오늘은 따뜻한 라멘 어때요?",
                    "🍕 피자 한 조각에 행복을!",
